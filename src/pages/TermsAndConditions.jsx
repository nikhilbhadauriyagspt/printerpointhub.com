...
export default function TermsAndConditions() {
  return (
    ...
    >
      ...
      <p>
        We are PRINTER POINT HUB  ("Company," "we," "us," "our"), a company registered in North Carolina, United States at 500 W Peace St, Raleigh, NC 27603, USA.
      </p>
      <p>
        We operate the website <a href="http://printerpointhub.com/">http://printerpointhub.com/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
        PRINTER POINT HUB is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading technology brands.
      </p>
      <p>
        You can contact us by email at <a href="mailto:info@printerpointhub.com">info@printerpointhub.com</a>, or by mail to 500 W Peace St, Raleigh, NC 27603, United States.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and PRINTER POINT HUB , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      </p>
      ...
      <div className="bg-[#F8FAFC] p-8 rounded-[2rem] border border-slate-100 my-12 not-prose hover:border-indigo-100 transition-colors duration-500">
        <h2 className="text-xl font-black text-slate-900 uppercase mt-0 mb-6 tracking-widest flex items-center gap-3">
          <div className="h-1 w-6 bg-indigo-600 rounded-full" /> Table of Contents
        </h2>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@printerpointhub.com">info@printerpointhub.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://printerpointhub.com/return-policy">http://printerpointhub.com/return-policy</a>.</p>
      ...
      <p>We care about data privacy and security. Please review our Privacy Policy: <a href="http://printerpointhub.com/privacy-policy">http://printerpointhub.com/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase tracking-tighter">
          ...
          <p>United States</p>
          <p className="pt-4 text-indigo-600 font-black lowercase">Email: info@printerpointhub.com</p>
        </address>
      </div>
    </PolicyLayout>
  );
