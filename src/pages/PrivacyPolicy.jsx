...
export default function PrivacyPolicy() {
  return (
    ...
    >
      <p className="lead">
                 This Privacy Notice for PRINTER POINT HUB  ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:      </p>
      <ul>
        <li>Visit our website at <a href="http://printerpointhub.com/">http://printerpointhub.com/</a> or any website of ours that links to this Privacy Notice</li>
                 <li>Use Printers, Consumables & Accessories. PRINTER POINT HUB is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading technology brands.</li>        <li>Engage with us in other related ways, including any marketing or events</li>
      </ul>
      <p>
        Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@printerpointhub.com">info@printerpointhub.com</a>.
      </p>

      <div className="bg-[#F8FAFC] p-8 rounded-[2rem] border border-slate-100 my-12 not-prose hover:border-indigo-100 transition-colors duration-500">
        <h2 className="text-xl font-black text-slate-900 uppercase mt-0 mb-6 tracking-widest flex items-center gap-3">
          <div className="h-1 w-6 bg-indigo-600 rounded-full" /> Summary of Key Points
        </h2>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="http://printerpointhub.com/cookie-policy">http://printerpointhub.com/cookie-policy</a>.</p>
      ...
      <p><strong>Cookies and similar technologies:</strong> Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: <a href="http://printerpointhub.com/cookie-policy">http://printerpointhub.com/cookie-policy</a>.</p>
      <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:info@printerpointhub.com">info@printerpointhub.com</a>.</p>
      ...
      <h3>How to Exercise Your Rights</h3>
             <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at info@printerpointhub.com, by visiting <a href="http://printerpointhub.com/contact">http://printerpointhub.com/contact</a>, or by referring to the contact details at the bottom of this document.</p>      <p>Under certain US state data protection laws, you can designate an authorized agent to make a request on your behalf. We may deny a request from an authorized agent that does not submit proof that they have been validly authorized to act on your behalf in accordance with applicable laws.</p>
      ...
      <h3>Appeals</h3>
      <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:info@printerpointhub.com">info@printerpointhub.com</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
      ...
      <p>If you have questions or comments about this notice, you may email us at <a href="mailto:info@printerpointhub.com">info@printerpointhub.com</a> or contact us by post at:</p>
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed">
                     PRINTER POINT HUB <br />          Authorised HP Partner<br />
                     500 W Peace St<br />
