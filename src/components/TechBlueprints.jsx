    ...
    <section className="px-6 md:px-10 lg:px-12 py-24 bg-white font-urbanist">
      ...
      <div className="flex items-center gap-8 mb-20">
        <div className="h-[100px] w-px bg-gray-200 relative hidden sm:block">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3 h-3 bg-indigo-600 rounded-full"></div>
        </div>
        <div>
          <h2 className="text-4xl font-black text-slate-900 tracking-tighter uppercase leading-none">
            Technical <br /><span className="text-indigo-600 italic">Blueprints.</span>
          </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {techProducts.map((p, i) => (
          <motion.div 
            ...
            className="p-10 rounded-[3rem] border border-gray-100 bg-gray-50/30 relative group hover:bg-white hover:shadow-2xl hover:shadow-indigo-500/5 transition-all duration-500"
          >
            ...
            <div className="mb-12">
              <span className="text-[10px] font-black tracking-widest text-indigo-600 uppercase">{p.series}</span>
            ...
            <div className="mt-12 pt-8 border-t border-dashed border-gray-200">
               <div className="flex justify-between items-center">
                 ...
                 <button className="text-[10px] font-black text-indigo-600 uppercase tracking-widest hover:underline">Full Specs</button>
               </div>
            </div>
          </motion.div>
        ))}
